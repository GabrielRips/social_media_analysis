...
async function sendResponse(message, responseText) {
  try {
    switch (message.platform) {
      case 'instagram': return await sendInstagramResponse(message, responseText);
      case 'facebook':  return await sendFacebookResponse(message, responseText);
      case 'tiktok':    return await sendTikTokResponse(message, responseText);
      case 'youtube':   return await sendYouTubeResponse(message, responseText);
      case 'twitter':   return await sendTwitterResponse(message, responseText);
      default:
